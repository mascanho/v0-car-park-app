    ...
    <Tooltip>
      <TooltipTrigger asChild>
        <motion.button
          ...
          className="relative overflow-hidden rounded-xl bg-gradient-to-br from-primary/10 via-accent/10 to-primary/5 border border-primary/20 text-left w-full cursor-pointer"
        >
          <div className="absolute inset-0 pointer-events-none">
            <div className="absolute -top-4 -right-4 text-4xl opacity-20">
              🎂
            </div>
            <div className="absolute bottom-2 left-4 text-2xl opacity-15">
              🎉
            </div>
          </div>
          <div className="relative flex items-center gap-4 px-5 py-4">
            ...
            <div className="shrink-0 text-3xl opacity-30 hidden sm:block">
              🎉
            </div>
          </div>
        </motion.button>
